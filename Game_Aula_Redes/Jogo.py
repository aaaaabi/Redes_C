...
# MISSILS
missilV1 = pygame.image.load('Game_Aula_Redes/GAME/Assets/missilVerde1.png').convert_alpha()
...
missilV2 = pygame.image.load('Game_Aula_Redes/GAME/Assets/missilVerde2.png').convert_alpha()
